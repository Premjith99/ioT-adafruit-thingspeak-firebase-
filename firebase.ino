...
#define WIFI_SSID "preman"
#define WIFI_PASSWORD "123456789"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyATTxtBhRftXBACReK39HKi4w1gmahVHgQ"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://fir-demo-4aeb7-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "premjith1999j@gmail.com"
#define USER_PASSWORD "FirebaseDemo"
...
void loop()
{
  ...
  if (Firebase.ready() && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0))
  {
   ...
   // Serial.printf("Set bool... %s\n", Firebase.setBool(fbdo, F("/test/bool"), count % 2 == 0) ? "ok" : fbdo.errorReason().c_str());
    ...
    Serial.printf("Set float... %s\n", Firebase.setFloat(fbdo, F("/test/float"), distance) ? "ok" : fbdo.errorReason().c_str());
